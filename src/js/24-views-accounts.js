...
function openAccount(id) {
  ...
  const body = `
    ...
    <div class="grid g4" style="margin-top:12px">${kpi('Traced in', inr(r.tin || 0))}${kpi('Onward (traced)', inr(r.tout || 0))}${kpi('Cash / ATM', inr(r.cash || 0))}${kpi('Possibly available', inr(r.retained || 0), '', 'rgba(52,211,153,.18)')}</div>
