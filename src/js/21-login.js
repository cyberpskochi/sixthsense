...
function showLogin(msg = '') {
  ...
  else if ($('#locGo', b)) $('#locGo', b).onclick = () => { const n = $('#locName', b).value.trim(); if (n.length < 3) return toast('Enter a name or e-mail', 'warn'); S.user = { email: n.toLowerCase(), name: n, google: false }; showVaultScreen(); };
}
